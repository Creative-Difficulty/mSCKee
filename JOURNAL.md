# Split Keyboard with per-key backlighting — Journal Export

- Exported at: 2026-06-30T15:45:57Z
- Project ID: 4255
- Entries: 14
...
I also figured out that I can’t route with this trace width and how to change it. Now I just need to make it apply rertroactively to all other traces and redo some routing, because this thinner trace width is much easier to deal with. I already had the constraints setup correctly in the 'constraints' tab, but KiCad still used the minima from the 'Default' netclass, so I had to update those.
...
- ID: 16111
- Author: Alex
- Created At: 2026-06-23T19:41:00Z

### Content

Project transferred from Blueprint! Duration Transferred: 17.5h
